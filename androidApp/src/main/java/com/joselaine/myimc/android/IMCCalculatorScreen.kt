package com.joselaine.myimc.android
...
import com.joselaine.myimc.IMCCalculator
...
fun IMCCalculatorScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text("Insira seu altura (m)") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            modifier = Modifier.fillMaxWidth()
        )
        Spacer(modifier = Modifier.height(16.dp))
        Button(
            onClick = {
                ...
                val imc = IMCCalculator.calculateIMC(weightValue, heightValue)
